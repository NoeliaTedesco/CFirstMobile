...
public class P_InvitationPage extends BasePage {
	...
	public void cancelInvitation(String socio) {
		try {
			Log.info("Comienza la anulación de la invitación");
			...
			Log.info("Finaliza la anulación de la invitación");
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public void resendInvitation(String socio) {
		try {
			Log.info("Comienza el reenvio de la invitación");
			...
			PageHelper.WaitForPageLoading();
			Log.info("Finaliza el reenvio de la invitación");
		} catch (Exception e) {
			e.printStackTrace();
		}
